...
export interface RuntimeContextFileAudit {
  sourcePath?: string;
  runtimePath?: string;
...
export interface RuntimeContextRulesAudit {
  sourcePath?: string;
  runtimePath?: string;
...
export interface RuntimeContextSkillsSourceAudit {
  name: 'builtin' | 'external' | 'project' | 'user' | 'workspace' | 'plugin' | 'unknown';
  sourcePath?: string;
  runtimePath?: string;
  count?: number;
  tokens?: number;
...
export interface RuntimeContextSkillsAudit {
  totalSkills?: number;
  includedSkills?: number;
  tokens?: number;
  sources: RuntimeContextSkillsSourceAudit[];
}

export interface RuntimeContextPromptAudit {
  totalBytes: number;
...
export interface RuntimeContextAudit {
  ...
  cwd?: string;
  instructions: RuntimeContextFileAudit;
  rules: RuntimeContextRulesAudit;
  skills: RuntimeContextSkillsAudit;
  runtimePrompt: RuntimeContextPromptAudit;
  warnings: string[];
}
