...
export function SetupPage() {
  ...
  if (initialized === true && authenticated) {
    return <Navigate to="/setup/codex" replace />;
  }
    ...
    <div className="h-screen bg-background overflow-y-auto p-4 flex flex-col items-center justify-center">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-1">HappyCodex 初始设置</h1>
          <p className="text-sm text-muted-foreground">先创建管理员账号，完成后进入后台继续配置 IM 通道与 Agent 运行时</p>
        </div>
        ...
        <Card className="shadow-sm">
          <CardContent>
            <CreateAdminStep
              onDone={() => navigate('/setup/codex', { replace: true })}
