...
const VALID_TABS: SettingsTab[] = ['codex', 'registration', 'appearance', 'system', 'profile', 'my-channels', 'security', 'groups', 'memory', 'skills', 'mcp-servers', 'plugins', 'users', 'about', 'bindings', 'usage', 'monitor'];
const SYSTEM_TABS: SettingsTab[] = ['codex', 'registration', 'appearance', 'system'];
const FULLPAGE_TABS: SettingsTab[] = ['groups', 'memory', 'skills', 'mcp-servers', 'plugins', 'users', 'bindings', 'usage', 'monitor'];
        ...
        {FULLPAGE_TABS.includes(activeTab) ? (
          ...
          <div className="p-4 lg:p-8">
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <Card>
                <CardContent>
                  {activeTab === 'codex' && <CodexRuntimeSection />}
